...
<html lang = "eng">
					...
					<div class = "modal-content panel-primary">
						...
						<form method = "POST" action = "save_student_query.php" enctype = "multipart/form-data">
							<div class  = "modal-body">
								...
								<div class = "form-group">
									<label>Faculty</label>
									<input type = "text" name = "faculty" required = "required" class = "form-control" />
								</div>
							</div>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $f_student['faculty']?></td>
							<td><a class = "btn btn-danger rid" name = "<?php echo $f_student['id']?>" href = "#" data-toggle = "modal" data-target = "#delete"><span class = "glyphicon glyphicon-remove"></span></a> <a class = "btn btn-warning  eid" name = "<?php echo $f_student['id']?>" href = "#" data-toggle = "modal" data-target = "#edit_student"><span class = "glyphicon glyphicon-edit"></span></a></td>
						</tr>
						<?php
							}
						?>
	...
	<script type = "text/javascript">
		$(document).ready(function(){
			...
			$('.eid').click(function(){
				$id = $(this).attr('name');
				$('#edit_query').load('load_edit1.php?id=' + $id);
			});
		});
	</script>
</html>